            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="card">
                            <div class="header">
                                <h4 class="title">Jumlah Siswa PKL 2018/2019</h4>
                            </div>
                            <div class="content">
                                
                                <table class="table table-striped">
                                    <thead>
                                        <th>Jurusan</th><th>Jumlah</th>
                                    </thead>
                                    <tbody>
                                ...
                                <div class="footer">
                                    <div class="legend">
                                        <i class="fa fa-circle text-danger"></i> RPL
                                        <i class="fa fa-circle text-ungu"></i> MM
                                        <i class="fa fa-circle text-success"></i> AKL
                                        <i class="fa fa-circle text-primary"></i> OTKP                                                  
                                        <i class="fa fa-circle text-warning"></i> BDP
                                    </div>
                                    <hr>
                                    <div class="stats">
                    ...
                    <div class="col-md-6">
                        <div class="card">
                            ...
                            <div class="content">
                                <div class="row">
                                    <?php foreach($dudi as $d); $jum=$d->jum_dudi;?>
                                <div class="col-sm-4"><i class="fa fa-5x fa-briefcase"></i></div><div class="col-sm-6"><h3><b>
                                    
                                    <?php echo $jum?> DU/DI</b></h3></div>
                                </div>
                                <div class="footer">
